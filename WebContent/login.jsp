			...
			<TBODY>
										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title="" maxLength=16 size=16
														name=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码</FONT></TD>
													<TD><INPUT class=regtxt title=""   type=password
				...
				<TR>
					...
					<TD rowSpan=3><IMG height=180 alt="" src="images/crm_16.gif"
						width=24></TD>
					<TD><INPUT title=登录 type=image height=48 alt="" width=86
						src="images/crm_17.gif" name=image class="login_btn"></TD>
					<TD><IMG height=48 alt="" src="images/crm_18.gif" width=21></TD>
					<TD colSpan=2><IMG title=取消 height=48 alt=""
