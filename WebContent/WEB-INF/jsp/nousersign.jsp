...
<body>
	<div class="menu">
		<ul>
			<li><a href="<%=path%>/healthNoUserSign?time=1">上月</a></li>
			<li><a href="<%=path%>/healthNoUserSign?time=2">本月</a></li>
			<li><a href="<%=path%>/healthNoUserSign?time=3">上周</a></li>
			<li><a href="<%=path%>/healthNoUserSign?time=4">本周</a></li>
		</ul>
	</div>
